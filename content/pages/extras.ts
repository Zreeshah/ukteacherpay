...
export const extraPages: PageContent[] = [
...

  {
    ...
    secondaryKeywords: [
      "tax calculator for teachers", "tax calculator teacher", "income tax calculator teachers",
      "teacher income tax calculator", "supply teacher tax calculator",
      "teacher salary in uk per month after tax", "ect teacher salary after tax",
      "m1 teacher salary after tax", "teacher pay after tax",
      "teacher tax code", "1257l tax code teacher", "how much tax do teachers pay",
    ],
    ...
    blocks: [
      ...
      { kind: "h2", text: "Salary after tax by career stage, month by month" },
      { kind: "p", text: "Most teachers arriving here want one number: what lands in the bank. The table converts the main scale points into monthly net figures for a scheme member on 1257L outside London, covering the ECT-after-tax question new teachers ask most often." },
      { kind: "table", caption: "Monthly take-home by pay point, rest of England 2026/27 (calculated)", head: ["Point", "Gross annual", "Monthly gross", "Monthly net (approx.)"], rows: [
        ["M1 (first ECT year)", "£34,068", "£2,839", "≈£2,180"],
        ["M3", "£38,400", "£3,200", "≈£2,377"],
        ["M6", "£46,939", "£3,912", "≈£2,760"],
        ["U3", "£52,835", "£4,403", "≈£3,020"],
      ]},
      { kind: "p", text: "Figures assume standard tax code, scheme membership at current contribution tiers and no student-loan or salary-sacrifice deductions. Supply teachers should expect different results because agency payroll applies tax codes differently — run your own circumstances through the full [take-home calculator](/teacher-pay-calculator/) rather than relying on averages." },
    ],
    faq: [
      { question: "How much is an ECT teacher salary after tax?", answer: "A first-year ECT on M1 (£34,068) keeps roughly £2,180 of the £2,839 gross monthly salary as a pension-scheme member on the standard 1257L code, before student loans or other voluntary deductions. Exact figures shift with your circumstances." },
  ...
  },
  {
    ...
    secondaryKeywords: [
      "teacher pay rise", "teachers pay rise", "teacher pay increase",
      "teachers pay increase", "teaching pay rise", "when will teachers get a pay rise",
      "when do teachers get a pay rise", "teacher pay rise 2026 27 calculator",
      "teachers pay rise calculator", "what is my pay rise worth teacher",
      "how much is a 3 percent raise teacher", "teacher salary increase calculator",
    ],
    calculator: "pay-rise",
    intro:
    ...
    blocks: [
      ...
      { kind: "h2", text: "When will teachers get a pay rise? The annual timetable" },
      { kind: "p", text: "It is the most common pay-rise question teachers search, and the answer follows a fixed annual cycle. Knowing where in the cycle you are tells you whether silence from your payroll means delay or normal process." },
      { kind: "table", caption: "The pay-award year at a glance", head: ["When", "What happens"], rows: [
      ...
      { kind: "p", text: "Scottish teachers follow a different cycle entirely, negotiated through the SNCT rather than the STRB — timings and percentages can diverge from England and Wales in any given year. Model any scenario above once an award is confirmed, or stress-test a range using the projections below." },
