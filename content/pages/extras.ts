...
export const extraPages: PageContent[] = [
  ...
  // ---------------------------------------------------------------- 2
  {
    ...
    metaTitle: "Teacher Pension Advice — Free and Paid Options Compared",
    metaDescription:
    ...
    primaryKeyword: "teacher pension advice",
    secondaryKeywords: [
      "pension advice for teachers", "teachers pension help",
      "teacher pension guidance", "teachers pension financial adviser",
    ],
    calculator: "none",
    intro:
  ...
  // ---------------------------------------------------------------- 3
  {
    ...
    metaTitle: "CARE vs Final Salary Pension — Teachers' Schemes Compared",
    metaDescription:
    ...
    primaryKeyword: "care vs final salary",
    secondaryKeywords: [
      "teachers pension final salary", "care pension teachers",
      "mccloud remedy teachers", "teachers pension legacy scheme",
